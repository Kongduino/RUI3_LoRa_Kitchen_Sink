...
* `/th`: sends the temperature and humidity if you have either a [RAK1901](https://store.rakwireless.com/products/rak1901-shtc3-temperature-humidity-sensor) or an [HTU21D](https://www.mikroe.com/htu21d-click), or similar, connected.
